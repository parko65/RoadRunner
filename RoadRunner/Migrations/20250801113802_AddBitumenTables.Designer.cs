...
namespace RoadRunner.Migrations
{
    ...
    [Migration("20250801113802_AddBitumenTables")]
    partial class AddBitumenTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Entities.Models.Bitumen", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasColumnName("BitumenId");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("Id"));

                    b.Property<int?>("BitumenTankId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("BitumenTankId")
                        .IsUnique()
                        .HasFilter("[BitumenTankId] IS NOT NULL");

                    b.ToTable("Bitumens");
                });

            modelBuilder.Entity("Entities.Models.BitumenTank", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasColumnName("BitumenTankId");
            ...
            modelBuilder.Entity("Entities.Models.RecipeBitumenTank", b =>
                {
                    b.Property<int>("RecipeId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("RecipeId", "BitumenTankId");

                    b.HasIndex("BitumenTankId");

                    b.ToTable("RecipeBitumenTanks");
                });
            ...
            modelBuilder.Entity("Entities.Models.Bitumen", b =>
                {
                    b.HasOne("Entities.Models.BitumenTank", "BitumenTank")
                        .WithOne("Bitumen")
                        .HasForeignKey("Entities.Models.Bitumen", "BitumenTankId");

                    b.Navigation("BitumenTank");
                });
            ...
            modelBuilder.Entity("Entities.Models.RecipeBitumenTank", b =>
                {
                    b.HasOne("Entities.Models.BitumenTank", "BitumenTank")
                        .WithMany("RecipeBitumenTanks")
                        .HasForeignKey("BitumenTankId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Entities.Models.BitumenTank", b =>
                {
                    b.Navigation("Bitumen");

                    b.Navigation("RecipeBitumenTanks");
                });
